...
namespace test
{
    ...
    TEST(rename_type_test, test_rename_type)
    {
        ...
        EXPECT_SAME_TYPES(multiple_elements_tuple_t, multiple_elements_tuple_renamed_t);
    }
}